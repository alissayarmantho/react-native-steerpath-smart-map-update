# react-native-steerpath-smart-map-update

## Getting started

`$ npm install react-native-steerpath-smart-map-update --save`
...
- New functions 
  ...
  3. onLiveObjectUpdated

* Credit to origin sdk author (support@steerpath.com)
* I just developed new functions because the origin sdk doesn't have that functions.
...
`$ react-native link react-native-steerpath-smart-map-update`
...
import {
  SmartMapView,
  SmartMapManager,
} from "react-native-steerpath-smart-map-update";
const API_KEY = "...";
...
example project and `yarn add react-native-steerpath-smart-map-update --force` to see
